...
***
### OGN-077	中娅沙漏
“中娅沙漏”也得到了小幅表述更新，着重明确一点：它的技能适用于任意友方单位被摧毁的时机，不仅限于你打出它的那个回合。
| **原文** | **勘误后** |
| -------- | -------- |
| 待命（支付[A]正面朝下放置此牌，之后可支付[0]将其当作反应牌打出。）<br>下一次当友方单位被摧毁时，改为将此牌摧毁，___然后以休眠状态将该单位召回。___ （把该单位送回基地，此行动不算作移动。）<br><br>Hidden (Hide now for [A] to react with later for 0.)<br>The next time a friendly unit would die, kill this instead. ___Recall that unit exhausted.___ (Send it to base. This isn't a move.) | 待命（支付[A]正面朝下放置此牌，之后可支付[0]将其当作反应牌打出。）<br> ___如果一名友方单位被摧毁，则改为将此牌摧毁。移除该单位所受伤害，让其进入休眠状态，并将其召回。___（把该单位送回基地，此行动不算作移动。）<br><br>Hidden (Hide now for [A] to react with later for [0].)<br>If a friendly unit would die, kill this instead. ___Heal that unit, exhaust it, and recall it.___ (Send it to base. This isn't a move.) |

***
### OGN-102	传送门大营救
在英文版的卡面文字可能会产生误解（但我们在中文版中印刷正确）。
| **原文** | **勘误后** |
| -------- | -------- |
| 迅捷（可在你的回合或法术对决中打出。）<br>放逐一名友方单位，然后让其拥有者将它打出到其所属的基地，无视费用。<br><br>Action (Play on your turn or in showdowns.)<br>Banish a friendly unit, then play it to ___base___, ignoring its cost. | 迅捷（可在你的回合或法术对决中打出。）<br>放逐一名友方单位，然后让其拥有者将它打出到其所属的基地，无视费用。<br><br>Action (Play on your turn or in showdowns.)<br>Banish a friendly unit, then ___its owner___ plays it to ___their base___, ignoring its cost. |
...
***
### OGN-108	聚合变异
英文版本的聚合变异中存在印刷错误。聚合变异会受到勘误来纠正这一疏忽。同时，中文版本中使用了“变为”而非“增加”，我们选择保留英文版本“增加”这一描述。
> 描述说要改，但中文官方FAQ没改。（我自己先改成“增加至”）
...
***
### OGN-118	残响之魂
单位不会“看见”自己被摧毁除非他们拥有如绝念这样表明让他们能的技能。为了澄清，我们发布了一个勘误以向残响之魂增加词汇“其他”。
| **原文** | **勘误后** |
| -------- | -------- |
| 每回合首次：当你的 ___友方单位___ 被摧毁时，抽一张牌。<br><br>The first time  ___friendly unit___ dies each turn, draw 1. | 每回合首次，当你 ___的另一名友方单位___ 被摧毁时，抽一张牌。<br><br> The first time ___another friendly___ unit dies each turn, draw 1. |

***
### OGN-121	提莫，军事家
我们正在发布一个规则更新，改变提莫和其他进攻/防守触发式技能运行的方式，并且我们将以此对提莫发布一个较小的勘误。我们同样想澄清他的技能能做什么并且需要指定多少个目标。这与我们之前在这张卡上给出的指导相矛盾，因为我们已经检查了他的卡面文字、他的设计意图和我们的规则可以支持什么。
提莫拥有一个“当我防守时”的触发式技能。在之前的规则下，进攻和防守的触发式技能只有在战斗开始时发生。提莫的双触发条件希望能覆盖这种情况——他要么在战斗开始时触发技能，要么在向战斗中打出他时触发技能。
| **原文** | **勘误后** |
| -------- | -------- |
| ___待命（支付[A]正面朝下放置此牌，之后可支付[0]将其当作反应牌打出。）<br>当我防守一处战场、或从正面朝下的[待命]状态中打出时，展示你主牌堆顶部的五张牌，当中每有一张带有[待命]技能的卡牌，就对此处的一名敌方单位造成1点伤害，然后将展示的牌回收。<br><br>Hidden (Hide now for [A] to react with later for [0].)<br>When I defend or I'm played from [Hidden], reveal the top 5 cards of your Main Deck. Deal 1 to an enemy unit here for each card with , then recycle them.___ | ___待命（支付[A]正面朝下放置此牌，之后可支付[0]将其当作反应牌打出。）<br>当我防守时，选择一名此处的敌方单位，展示你主牌堆顶部的五张牌。当中每有一张带有[待命]技能的卡牌，就对该单位造成 1 点伤害，然后将展示的牌回收。<br><br>Hidden (Hide now for [A] to react with later for [0].)<br>When I defend, choose an enemy unit here and reveal the top 5 cards of your Main Deck. Deal 1 to that unit for each card with [Hidden] revealed this way, then recycle the revealed cards.___ |

***
### OGN-131	沙丘亚龙
一个印刷错误，这个错误在修订中文版本中未被发现。他将接受勘误。
| **原文** | **勘误后** |
| -------- | -------- |
|当我进攻时，如果此处有处于活跃状态的敌方单位，___则让我战力+2。___<br><br>When I attack, give me ___+2 Might___ if there is a ready enemy unit here.|当我进攻时，如果此处有活跃状态的敌方单位，___则让我在本回合内战力+2。___<br><br>When I attack, give me ___+2 Might this turn___ if there is a ready enemy unit here.|
...
| **原文** | **勘误后** |
| -------- | -------- |
| 当你打出我时，给予其他两名友方单位增益。（每名未拥有增益的单位获得一个战力+1增益。）<br><br>When you play me, buff ___up to___ two other friendly units.(Each one that doesn't have a buff gets a +1 Might buff.) | 当你打出我时，给予 ___最多___ 两名其他友方单位增益。（每名未拥有增益的单位获得一个战力+1增益。）<br><br>When you play me, buff ___up to___ two other friendly units.(Each one that doesn't have a buff gets a +1 Might buff.) |
...
***
### OGN-181	奇妙行囊
奇妙行囊可以选择一个友方装备、友方单位或友方在战场正面朝下的待命牌。它不能使具有待命技能的卡牌从任何其他地方返回手牌，比如玩家的废牌堆。为了让这一点更清晰，它将收到勘误并表明“正面朝下”而非“具有待命技能的卡牌”。
| **原文** | **勘误后** |
| -------- | -------- |
| 横置：让另一张友方装备、单位或 ___[待命]___ 卡牌返回其所属的手牌。<br><br>[E]: Return another friendly gear, unit, or ___[Hidden]___ card to its owner's hand. | 横置：让另一张友方装备、单位或 ___正面朝下___ 的卡牌返回其所属的手牌。<br><br>[E]: Return another friendly gear, unit, or ___facedown___ card to its owner's hand. |
...
| **原文** | **勘误后** |
| -------- | -------- |
| 支付 1 法力，横置：将战场上的一名友方单位移动到其所属的基地。<br><br> [1], [E]: Move a friendly unit at a battlefield to ___your___ base. | 支付[1]，横置：将战场上的一名友方单位移动到其所属的基地。<br><br>[1], [E]: Move a friendly unit at a battlefield to ___its___ base. |

***
### OGN-194	魔腾，惊魂夜
魔腾将收到勘误，以解决这些问题并使其符合设计初衷。这个勘误将明确魔腾的技能并非是触发式技能，且他会使用放逐来作为保存区域。它同样会明确展示和查看同样生效，尽管我们会在规则中明确这一点，我们也希望卡面文字可以明确体现。
| **原文** | **勘误后** |
| -------- | -------- |
| 游走（我可以向其他战场进行移动。）<br>___当你查看主牌堆顶部的卡牌（不是抽牌）并看到我时，可以选择支付[A]将我打出。___ <br><br>Ganking(I can move from battlefield to battlefield.)<br>___When you look at cards from the top of your deck (and don't draw them) and see me,___ you may play me for [power]. | 游走（我可以向其他战场进行移动。）<br>___你查看或展示主牌堆顶部的卡牌并看到我时，可以选择将我放逐。如选择放逐，则你可以选择支付[A]将我打出。___ <br><br>Ganking (I can move from battlefield to battlefield.)<br>___As you look at or reveal me from the top of your deck, you may banish me.___ If you do, you may play me for [A]. |

***
### OGN-199	控潮者
控潮者会收到较小的勘误，同时限制它选择的单位需要由你控制并确保他能在这些规则下选择其他地点的单位。
| **原文** | **勘误后** |
| -------- | -------- |
...
***
### OGN-227	烈阳徽记	
只会召回包含在这场平局中的单位。它将收到细微的勘误以明确这一点。
| **原文** | **勘误后** |
| -------- | -------- |
| 当你作为进攻方时，如果战斗以平局告终，则召回双方所有单位。（把该单位送回基地，此行动不算作移动。平局将在造成战斗伤害后结算。）<br><br>If a combat where you are the attacker ends in a tie, recall ALL units instead. (Send them to base. This isn't a move. Ties are calculated after combat damage is dealt.) | 当你作为进攻方时，如果战斗结果为平局且需要召回你的任意数量单位，改为召回 ___该战场双方___ 的所有单位。（将其送回基地，此行动不算作移动。平局将在造成战斗伤害后结算。）<br><br>If a combat where you are the attacker ends in a tie that would recall any of your units, recall ___all units at that battlefield___ instead. (Send them to base. This isn't a move. Ties are calculated after combat damage is dealt.)|

***
### OGN-235	卡尔玛，圣灵之媒
当符文战场中的卡面文字提到“卡牌”，它指的只是主牌堆中的牌。卡尔玛后续的卡面文字将表明这一点。更新后的规则会标明在卡面文字中不管谁导致了回收卡牌，玩家永远只会回收自己的卡牌。为了修复这一点，卡尔玛将收到勘误。
| **原文** | **勘误后** |
| -------- | -------- |
| 预知（当你打出我时，查看主牌堆顶部的一张牌，你可以选择将其回收。）<br>___每当你回收任意数量的卡牌___ 时，给予一名友方单位增益。（如果该单位未拥有增益，则获得一个[S]+1增益。符文不被视为卡牌。）<br><br>Vision (When you play me, look at the top card of your Main Deck. You may recycle it.)<br>When you recycle ___one or more cards___, buff a friendly unit. (If it doesn't have a buff, it gets a +1 might buff. Runes aren't cards.) | 预知（当你打出我时，查看主牌堆顶部的一张牌，你可以选择将其回收。）<br>___每当你将任意数量的卡牌回收到自己的主牌堆时___，给予一名友方单位增益。（如果该单位未拥有增益，则获得一个[战力]+1增益。符文不被视为卡牌。）<br><br>"Vision (When you play me, look at the top card of your Main Deck. You may recycle it.)<br>When you recycle ___one or more cards to your Main Deck___, buff a friendly unit. (If it doesn't have a buff, it gets a +1 [M] buff.)"|
...
| **原文** | **勘误后** |
| -------- | -------- |
| 支付[1]和[黄色]，[横置]：摧毁一名友方单位，然后查看主牌堆顶部的五张牌。___你可以选择从中打出一名战力比被摧毁单位最多高1点的单位卡牌___，无视费用，然后回收其余的卡牌。<br><br>[1][C], [E]: Kill a friendly unit. Look at the top 5 cards of your Main Deck. You may play a unit from among them that has Might up to 1 more than the killed unit, ignoring its cost. Then recycle the rest. | 支付[1]和[黄色]，横置：摧毁一名友方单位。查看你主牌堆顶部的五张牌。___你可以选择从中放逐一名战力比被摧毁单位最多高 1 点的单位卡牌，并将其打出___，无视费用，然后回收其余的卡牌。<br><br>[1][C], [E]: Kill a friendly unit. Look at the top 5 cards of your Main Deck. ___You may banish a unit from among them that has Might up to 1 more than the killed unit and play it___, ignoring its cost. Then recycle the rest. |

***
### OGN-258	猛龙摆尾
猛龙摆尾在现在运作的比之前略好，因为它需要同时选择移动的单位和移动终点，但这仍然有一些奇怪。因此，它将收到勘误，在其中引入一个 **内嵌式触发（reflexive trigger）** 的概念——包含在其他法术或技能中的触发式技能，它会在结算链上创建一个区别于原法术或技能的新技能。
| **原文** | **勘误后** |
| -------- | -------- |
| 移动一名敌方单位。___随后，___ 在其目的地处选择另一名敌方单位，让这两名单位相互以自身战力给对方造成伤害。<br><br>Move an enemy unit. ___Then___ choose another enemy unit at its destination. They deal damage equal to their Mights to each other. | 移动一名敌方单位。___然后进行一次：在该单位终点位置处选择另一名敌方单位___ 。这两名单位相互以自身战力给对方造成伤害。<br><br>Move an enemy unit. ___Then do this:___ Choose another enemy unit at its destination. They deal damage equal to their Mights to each other. |
...
| **原文** | **勘误后** |
| -------- | -------- |
| 支付 2 法力，横置：在战场和其所属基地之间移动一名友方单位。<br><br> [2], [E]: Move a friendly unit to or from ___your___ base.| 支付[2]，横置：在战场和其所属基地之间移动一名友方单位。<br><br>[2], [E]: Move a friendly unit to or from ___its___ base.|

***
### OGN-269	腕豪
腕豪的技能被错误地描述为类似触发式技能。他将收到描述更新以明确其技能为替换效果。
| **原文** | **勘误后** |
| -------- | -------- |
| ___每当___ 一名拥有增益且受你控制的单位被摧毁时，你可以选择支付[A]让我变为休眠状态，以此消耗该单位身上的增益，___然后改为以休眠状态将其召回。___（把该单位送回基地，此行动不算作移动。）<br>当你征服一处战场时，让我变为活跃状态。<br><br>___When___ a buffed unit you control would die, you may pay rune and exhaust me to spend its buff and ___recall it exhausted instead.___ (Send it to base. This isn't a move.)<br>When you conquer, ready me. | ___如果___ 一名拥有增益且受你控制的单位被摧毁，则你可以选择支付[A]，让我变为休眠状态，并消耗该单位身上的增益，___以改为移除该单位所受伤害，让其进入休眠状态，并将其召回。___（把该单位送回基地，此行动不算作移动。）<br>当你征服一处战场时，让我变为活跃状态。<br><br>___If___ a buffed unit you control would die, you may pay [A], exhaust me, and spend its buff to ___heal it, exhaust it, and recall it instead.___ (Send it to base. This isn't a move.)<br>When you conquer, ready me. |
